<?php
	/*
		...
		Önce bir form hazırla. Formda Dosya File Field ( Insert - Form - File Field ) kullanılır. Bu alanı ekleyince FORMUN ENCTYPE özelliği 
...
<body>
	<?php
		...
		$dosya_dizisi 	= 	pathinfo($name);
		$uzanti 		= 	$dosya_dizisi["extension"];
		...
		*/
		...
		if ($ad_soyad and $resim_dizisi["name"]) {
			...
			if ($uzanti != "jpg" and $uzanti != "jpeg" and $uzanti != "gif" and $uzanti != "png") {
				echo "HATA : Lütfen jpg, jpeg, gif,png uzantılı bir resim dosyası seçiniz";
			} elseif ($size > 1000000) {
				echo "HATA : Dosya boyutunuz 1 MB'dan küçük olmalıdır";
			} else {
				//upload başladı
	...
	<form action="" method="post" enctype="multipart/form-data">
		...
		<p><input type="submit" name="btn_ekle" value="Ürün ekle"></p>
	</form>
